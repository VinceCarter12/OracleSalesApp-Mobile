  ...
  return (
    <YStack flex={1} backgroundColor={COLORS.snow} paddingTop={insets.top}>
      ...
      <ScrollView contentContainerStyle={{ paddingHorizontal: 16, paddingBottom: 96 }}>
        ...
        {/* Sync chip — static until the offline outbox lands (T-002/T-007). */}
        <XStack
          alignItems="center"
          gap="$2.5"
        ...
        >
          ...
          <YStack>
            <Text fontSize={12.5} fontWeight="800" color={COLORS.blue}>Sync status</Text>
            <Text fontSize={11} fontWeight="600" color="#3B5878">Auto-uploads kapag may signal</Text>
          </YStack>
        </XStack>
