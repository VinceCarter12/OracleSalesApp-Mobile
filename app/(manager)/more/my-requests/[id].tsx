...
/**
 * Manager twin of app/(tabs)/more/my-requests/[id].tsx — see that file's doc
 * comment and this route's sibling index.tsx for why this screen exists.
 * View-only, identical body to the Sales/RSR version; only the fallback
 * route differs.
 */
export default function ManagerMyRequestDetailScreen() {
